    ...
    <main class="container">
        <div class="product-detail-container">
            ...
            <div class="product-detail-image">
                <img src="view/images/20.jpg" alt="Nom du produit">
            </div>
            ...
            <div class="product-detail-info">
                ...
                <div class="stock-status">
                    <span class="status-icon in-stock"></span> En stock (22 unités) <!-- TEMP    le temps que je fasse la bdd et que fasse un stock  -->
                ...
                <form action="index.php?action=ajouter_au_panier" method="POST" class="add-to-cart-form">
                    ...
                    <input type="hidden" name="nom" value="20 euro carte kdo">
